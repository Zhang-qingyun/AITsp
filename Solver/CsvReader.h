...
#ifndef SMART_ZQY_P_CENTER_CSV_READER_H
#define SMART_ZQY_P_CENTER_CSV_READER_H
...
#define SMART_ZQY_P_CENTER_CSV_READER_RECURSIVE_VERSION  0
...
public:
    ...
    const std::vector<Row>& scan(std::ostringstream &oss) {
        ...
        #if SMART_ZQY_P_CENTER_CSV_READER_RECURSIVE_VERSION
        onNewLine(begin);
        #else
        onNewLine_opt(begin);
        #endif // SMART_ZQY_P_CENTER_CSV_READER_RECURSIVE_VERSION
...
//Label_OnValue:
    ...
    // TODO[zqy][2]: handle quote (comma will not end cell).
    // EXTEND[zqy][5]: make trim space configurable.
...
#endif // SMART_ZQY_P_CENTER_CSV_READER_H
